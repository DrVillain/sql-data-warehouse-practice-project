...
Notes:
    - Each table includes a dwh_create_date column to track load timestamps.
    - Existing tables are dropped before recreation; this is destructive
      and will result in loss of any existing data in these tables.
===============================================================================
*/
